    ...
    internal class CategoryMapper
    {
        ...
        internal CategoryMapper()
        {
            czechNameToCategoryMap = new Dictionary<string, Category>
            {
                ...
                { "Citáty a přísloví", Category.QuotesAndProverbs },
                ...
                { "Ekonomie a obchod", Category.EconomicsAndBusiness },
                ...
                { "Literatura naučná", Category.EducationalLiterature },
                { "Slovenská literatura", Category.SlovakLiterature },
                { "Literatura slovenská", Category.SlovakLiterature },
                ...
                { "Obrazové publikace", Category.PictorialPublications },
                ...
                { "Pohádky a bajky", Category.FairyTales },
                ...
                { "Pragensia", Category.PragueStudies },
                { "Právo", Category.Law },
                ...
                { "Sociologie", Category.SociologySociety },
                { "Společnost", Category.SociologySociety },
                ...
                { "Technika a elektro", Category.TechnologyAndElectronics },
                ...
                { "Vzdělávání, školství", Category.Education },
